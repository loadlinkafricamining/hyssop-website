...
export function WhatsappFab() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-30 flex h-12 items-center gap-2 rounded-full bg-olive-dark px-5 text-cream shadow-lg shadow-ink/15 transition-opacity hover:opacity-85"
    >
