    ...
    <section className="py-24 lg:py-32">
      <Container size="wide">
        <div className="grid gap-6 lg:grid-cols-[1.3fr_1fr]">
          <Reveal className="relative flex aspect-[4/3] flex-col justify-end overflow-hidden bg-beige p-8 lg:p-12">
            <Image
          ...
          <Reveal
            delay={0.12}
            className="relative flex aspect-[4/3] flex-col justify-end overflow-hidden bg-beige p-8 lg:p-12"
          >
            <Image
